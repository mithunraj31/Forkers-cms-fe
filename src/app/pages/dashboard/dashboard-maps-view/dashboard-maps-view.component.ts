...
@Component({
  selector: 'frk-dashboard-maps-view',
  styleUrls: ['./dashboard-maps-view.component.scss'],
  templateUrl: './dashboard-maps-view.component.html',
})
export class DashboardMapsViewComponent implements OnInit {
